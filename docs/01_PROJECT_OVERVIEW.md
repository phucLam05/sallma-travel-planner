...
* *Giới hạn tính năng*: Hệ thống chỉ tập trung vào việc tạo lịch trình, tìm kiếm khách sạn, tính toán chi phí tổng thể và xử lý các yêu cầu thay đổi (Refine) từ người dùng.

* *Công nghệ lõi*: Sử dụng Python, LangGraph để quản lý luồng, Streamlit cho giao diện UI và mô hình OpenAI GPT-4o-mini để suy luận.